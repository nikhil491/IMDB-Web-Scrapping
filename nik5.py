...
celeb_name = []
name = soup.find_all('h3', {'class':'lister-item-header'})
0
...
celeb_detail = []
detail = soup.find_all('div', {'class':'lister-item-content'},'p')
for details in detail:
    #print (details.text)
    celeb_detail.append(details.text)

celeb_images = []
images = soup.find_all('div', {'class':'lister-item-image'})
for image in images:
    #print (image.img["src"])
...
def Final_Output():
    ...
    ckey = 'w79VtvXA7x8opmqaQig5xEYxO'
    csecret = 'VuePmctlqeclYqyoz11ziDzxrOU3e4DecAOEh5egPXSdFTRrPG'
    atoken = '2264262288-ymDam3Tdhk1ZyxVeh3ttbb00zD1ST4NMxeiwhdR'
    asecret = 'LsDnAnpLOJ4BWxzTRvXRFW3uFhHGAn2segQ0qmuo0sOva'
    import tweepy
   ...
   # print(public_tweets.text.encode('UTF-8'))

    print ("List of tweets for celebrity %s -> " % str(celeb_name[0]))
    ...
    for tweets in public_tweets:
         ...
         print ("The sentiment analysis of this tweet for %s is:" % str(celeb_name[0]))
   ...
   #print ('\n\n\n')
    ...
    tweet_zero =  "The Overall sentiment for  %s, %s  is :" %(celeb_name[0], Overall_sentiment())


   #print ("\n\n\n\n")

    #######################################################################################
    print ("List of tweets for celebrity %s -> " % str(celeb_name[1]))
    ...
    for tweets in public_tweets1:
           ...
           print ("The sentiment analysis of this tweet for  %s is:" % str(celeb_name[1]))
    ...
    print ('\n\n\n')
    tweet_first = "The Overall sentiment for %s,%s is :" %(celeb_name[1], Overall_sentiment1())


    print ("\n\n\n\n")

    #######################################################################################
    print ("List of tweets for celebrity %s -> " % str(celeb_name[2]))
    ...
    for tweets in public_tweets2:
            ...
            print ("The sentiment analysis of this tweet for  %s is:" % str(celeb_name[2]))
    ...
    tweet_second = "The Overall sentiment for %s,%s is :" %(celeb_name[2], Overall_sentiment2())
    ...
    print ("List of tweets for celebrity %s -> " % str(celeb_name[3]))
    ...
    for tweets in public_tweets3:
          ...
          print ("The sentiment analysis of this tweet for  %s is:" % str(celeb_name[3]))
    ...
    tweet_third = "The Overall sentiment for %s,%s is :" %(celeb_name[3], Overall_sentiment3())
    ...
    print ("List of tweets for celebrity %s -> " % str(celeb_name[4]))
    ...
    for tweets in public_tweets4:
          ...
          print ("The sentiment analysis of this tweet for  %s is:" % str(celeb_name[4]))
    ...
    tweet_fourth = "The Overall sentiment for %s,%s is :" %(celeb_name[4], Overall_sentiment4())
    ...
    print ("List of tweets for celebrity %s -> " % str(celeb_name[5]))
    ...
    for tweets in public_tweets5:
          ...
          print ("The sentiment analysis of this tweet for  %s is:" % str(celeb_name[5]))
    ...
    tweet_fifth = "The Overall sentiment for %s,%s is :" %(celeb_name[5], Overall_sentiment5())
    ...
    print ("List of tweets for celebrity %s -> " % str(celeb_name[6]))
    ...
    for tweets in public_tweets6:
         ...
         print ("The sentiment analysis of this tweet for  %s is:" % str(celeb_name[6]))
    ...
    tweet_sixth = "The Overall sentiment for %s,%s is :" %(celeb_name[6], Overall_sentiment6())
    ...
    for tweets in public_tweets7:
          ...
          print ("The sentiment analysis of this tweet for  %s is:" % str(celeb_name[7]))
    ...
    tweet_seventh = "The Overall sentiment for %s,%s is :" %(celeb_name[7], Overall_sentiment7())
    ...
    print ("List of tweets for celebrity %s -> " % str(celeb_name[8]))
    ...
    for tweets in public_tweets8:
          ...
          print ("The sentiment analysis of this tweet for  %s is:" % str(celeb_name[8]))
    ...
    tweet_eighth = "The Overall sentiment for %s,%s is :" %(celeb_name[8], Overall_sentiment8())
    ...
    print ("List of tweets for celebrity %s -> " % str(celeb_name[9]))
    ...
    for tweets in public_tweets9:
          ...
          print ("The sentiment analysis of this tweet for  %s is:" % str(celeb_name[9]))
    ...
    tweet_ninth = "The Overall sentiment for %s,%s is :" %(celeb_name[9], Overall_sentiment9())
